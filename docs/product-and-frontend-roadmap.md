...
| Fallback/schema assets | Required by the spec | Generated by `backend/eval/precompute.py` into `frontend/public/fallback/` (meta, report, five curated days, three sections, tiles) | Frontend wires up loading from `frontend/public/fallback/` before resilience claims. |
